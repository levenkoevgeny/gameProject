...
def init_questions(apps, schema_editor):
    ...
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=5)),
                          answer_text="Вы выезжаете для задержания лица сами вместе с коллегой из НЦБ Интерпола в Республике Беларусь",
                          score=1,
                          next_question=Subquery(Question.objects.get(question_number=7)))
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=5)),
    ...
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=6)),
    ...
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=7)),
                          answer_text="ЗАДЕРЖАНИЕ в порядке ст. 510 УПК Республики Беларусь",
                          score=1,
                          next_question=Subquery(Question.objects.get(question_number=8)))
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=7)),
                          answer_text="ЗАДЕРЖАНИЕ в порядке ст. 108 УПК Республики Беларусь",
                          score=-1)

    Answer.objects.create(question=Subquery(Question.objects.get(question_number=8)),
    ...
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=8)),
                          ...
                          score=1,
                          next_question=Subquery(Question.objects.get(question_number=9)))

    Answer.objects.create(question=Subquery(Question.objects.get(question_number=9)),
                          answer_text="Об освобождении",
                          score=-1)
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=9)),
                          answer_text="О заключении под стражу",
                          score=1,
                          next_question=Subquery(Question.objects.get(question_number=10)))
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=9)),
                          answer_text="О выдаче лица",
                          score=-1)

    Answer.objects.create(question=Subquery(Question.objects.get(question_number=10)),
    ...
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=10)),
                          ...
                          score=1,
                          next_question=Subquery(Question.objects.get(question_number=11)))

    Answer.objects.create(question=Subquery(Question.objects.get(question_number=11)),
    ...
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=11)),
                          ...
                          score=1,
                          next_question=Subquery(Question.objects.get(question_number=12)))

    Answer.objects.create(question=Subquery(Question.objects.get(question_number=12)),
                          answer_text="Осуществляют проверку по материалу, зарегистрированному в ЕК, и ОРМ по установлению местонахождения лица",
                          score=1,
                          next_question=Subquery(Question.objects.get(question_number=13)))
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=12)),
                          answer_text="Не осуществляют иных ОРМ и процессуальных действий",
                          score=-1)

    Answer.objects.create(question=Subquery(Question.objects.get(question_number=13)),
                          answer_text="Нет",
                          score=-2)
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=13)),
    ...
    Answer.objects.create(question=Subquery(Question.objects.get(question_number=13)),
                          ...
                          score=1,
                          next_question=Subquery(Question.objects.get(question_number=14)))

    Answer.objects.create(question=Subquery(Question.objects.get(question_number=14)),
